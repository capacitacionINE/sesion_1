...
- La capacitación se compone de **9 sesiones**.
...
**Sesión 2:** Procesamiento de bases de datos (1) (en 2 partes)
...
**Sesión 7:** Más sobre edición de datos
    ...
    - Introducción al manejo de strings y `stringr`
    - Expresiones regulares
    - Aplicaciones para la exploración y edición de strings
...
--
<br/>
**Sesión 8:**  En camino a la reproducibilidad
...
.pur[Es el formato más común al que nos enfrentamos diariamente] en hojas de cálculo, programas como Excel, SPSS, Stata, etc.
...
.medium-par-red[Para eso debemos utilizar la función `table()` y el operador "$", que vincula a una variable con un objeto.]
...
#  Mini- ejercicio 3 <strike>(yfinal)</strike> 
...
**pista:** R es *case sensitive*, y los nombes tienen su primera letra mayúscula (p.e: "Camila").
