...
Un vector es una forma de **almacenar datos** que permiten contener **una serie de valores del mismo tipo**.
...
La función "c" (combine) permite unir valores en un vector.
