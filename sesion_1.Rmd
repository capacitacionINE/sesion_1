...
En términos simples es lo que entendemos por **variable**.
...
.medium-par[Que los vectores sea antómicos ⚛️ significa .medium-par-red[solo pueden contener un tipo de datos.]]
...
.pur[Es el formato más común al que nos enfrentamos diariamente] en hojas de cálculo, programas como SPSS, Stata, etc.
...
.pur[Esta estructura es más compleja de entender], pero en la parte II de este ciclo de capacitaciones verán que son .pur[muy útiles].
